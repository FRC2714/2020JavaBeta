...
public class CustomRamseteCommand extends CommandBase {
	...
	/**
	 * Constructs a new CustomRamseteCommand that, when executed, will follow the provided trajectory.
	...
	public CustomRamseteCommand(Trajectory trajectory,
		...
		m_trajectory = requireNonNullParam(trajectory, "trajectory", "CustomRamseteCommand");
		m_pose = requireNonNullParam(pose, "pose", "CustomRamseteCommand");
		m_follower = requireNonNullParam(controller, "controller", "CustomRamseteCommand");
		m_ks = ksVolts;
		m_kv = kvVoltSecondsPerMeter;
		m_ka = kaVoltSecondsSquaredPerMeter;
		m_kinematics = requireNonNullParam(kinematics, "kinematics", "CustomRamseteCommand");
		m_leftSpeed = requireNonNullParam(leftWheelSpeedMetersPerSecond,
				"leftWheelSpeedMetersPerSecond",
				"CustomRamseteCommand");
		m_rightSpeed = requireNonNullParam(rightWheelSpeedMetersPerSecond,
				"rightWheelSpeedMetersPerSecond",
				"CustomRamseteCommand");
		m_leftController = requireNonNullParam(leftController, "leftController", "CustomRamseteCommand");
		m_rightController = requireNonNullParam(rightController, "rightController", "CustomRamseteCommand");
		m_output = requireNonNullParam(outputVolts, "outputVolts", "CustomRamseteCommand");
	...
	public CustomRamseteCommand(Trajectory trajectory,
		...
		m_trajectory = requireNonNullParam(trajectory, "trajectory", "CustomRamseteCommand");
		m_pose = requireNonNullParam(pose, "pose", "CustomRamseteCommand");
		m_follower = requireNonNullParam(follower, "follower", "CustomRamseteCommand");
		m_kinematics = requireNonNullParam(kinematics, "kinematics", "CustomRamseteCommand");
		m_output = requireNonNullParam(outputMetersPerSecond, "output", "CustomRamseteCommand");
